...
public class EntityBoat extends EntityVehicle {
    ...
    public boolean onUpdate(int currentTick) {
        ...
        if (this.isAlive()) {
            ...
            this.motionY = (this.level.getBlock(blockTemporalVector.setComponents(this.x, this.y, this.z)).getBoundingBox() != null || this.isInsideOfWater()) ? getGravity() : -0.08;
            ...
            if (this.onGround && (Math.abs(this.motionX) > 0.00001 || Math.abs(this.motionZ) > 0.00001)) {
                friction *= this.getLevel().getBlock(this.blockTemporalVector.setComponents((int) Math.floor(this.x), (int) Math.floor(this.y - 1), (int) Math.floor(this.z) - 1)).getFrictionFactor();
            }
