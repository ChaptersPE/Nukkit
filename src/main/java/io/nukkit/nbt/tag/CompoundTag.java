...
public class CompoundTag extends Tag {
    ...
    public int getByte(String name) {
        ...
        return ((NumberTag) tags.get(name)).getNumber().intValue();
    }
    ...
    public long getLong(String name) {
        ...
        return ((NumberTag) tags.get(name)).getNumber().longValue();
    }

    public float getFloat(String name) {
        if (!tags.containsKey(name)) return (float) 0;
        return ((NumberTag) tags.get(name)).getNumber().floatValue();
    }

    public double getDouble(String name) {
        if (!tags.containsKey(name)) return (double) 0;
        return ((NumberTag) tags.get(name)).getNumber().doubleValue();
    }
    ...
    public String getString(String name) {
        ...
        if (tag instanceof NumberTag) {
            return String.valueOf(((NumberTag) tag).getNumber());
        }
