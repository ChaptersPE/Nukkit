...
import io.nukkit.plugin.java.JavaPlugin;
 ...
 * file.
 * <p>
 * When Nukkit loads a plugin, it needs to know some basic information about
...
public final class PluginDescriptionFile {
     ...
     * itself.
     * <li>If your namespace is <code>io.nukkit.plugin</code>, and your class
     * file is called <code>MyPlugin</code> then this must be
     * <code>io.nukkit.plugin.MyPlugin</code>
     * <li>No plugin can use <code>io.nukkit.</code> as a base package for
     ...
     * <p>
     * Example:
     * <blockquote><pre>main: oio.nukkit.plugin.MyPlugin</pre></blockquote>
     *
     ...
     * <li>A nukkit.io forum handle or email address is recommended.
     ...
     * gracefully substituted, previous versions of Nukkit (ones prior to the
    ...
    private void loadMap(Map<?, ?> map) throws InvalidDescriptionException {
        ...
        try {
            ...
            if (main.startsWith("io.nukkit.")) {
                throw new InvalidDescriptionException("main may not be within the io.nukkit namespace");
            }
        } catch (NullPointerException ex) {
