...
public class ItemStack implements Cloneable, ConfigurationSerializable {
    ...
    public void setTypeId(int type) {
        this.type = type;
        if (this.meta != null) {
            this.meta = Nukkit.getItemFactory().asMetaFor(meta, getType0());
        }
        createData((byte) 0);
    }
    ...
    public boolean isSimilar(ItemStack stack) {
        ...
        return getTypeId() == stack.getTypeId() && getDurability() == stack.getDurability() && hasItemMeta() == stack.hasItemMeta() && (hasItemMeta() ? Nukkit.getItemFactory().equals(getItemMeta(), stack.getItemMeta()) : true);
    }
    ...
    public void addUnsafeEnchantment(Enchantment ench, int level) {
        (meta == null ? meta = Nukkit.getItemFactory().getItemMeta(getType0()) : meta).addEnchant(ench, level, true);
    }
    ...
    public boolean hasItemMeta() {
        return !Nukkit.getItemFactory().equals(meta, null);
    }
