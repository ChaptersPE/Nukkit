...
public class MemorySection implements ConfigurationSection {
    ...
    public io.nukkit.util.Vector getVector(String path, io.nukkit.util.Vector def) {
        Object val = get(path, def);
        return (val instanceof io.nukkit.util.Vector) ? (io.nukkit.util.Vector) val : def;
    }

    public boolean isVector(String path) {
        Object val = get(path);
        return val instanceof io.nukkit.util.Vector;
    }
